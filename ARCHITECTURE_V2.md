# PearlAlgo Architecture v2 - IBKR-Independent System

## Overview

PearlAlgo v2 is a professional-grade, vendor-agnostic quantitative trading platform that operates **completely independently of IBKR**. The system uses modular architecture patterns similar to professional quant firms (HRT, Jump, Two Sigma, Citadel).
