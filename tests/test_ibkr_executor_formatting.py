...
class TestFormatPriceHelper:
    ...
    def test_import_does_not_raise(self) -> None:
        """
        Importing ibkr_data_executor module should not raise.
        This verifies the module can be loaded without network calls.
        """
        # This import should not raise or make network calls
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_price
...
class TestFormatIntHelper:
    ...
    def test_import_does_not_raise(self) -> None:
        ...
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_int
...
class TestIsValidPriceHelper:
    ...
    def test_import_does_not_raise(self) -> None:
        ...
        from pearlalgo.data_providers.ibkr_data_executor import _is_valid_price
...
class TestModuleImportIsDeterministic:
    ...
    def test_multiple_imports_consistent(self) -> None:
        ...
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_price as fp1
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_price as fp2
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_int as fi1
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_int as fi2
    ...
    def test_formatting_is_deterministic(self) -> None:
        ...
        from pearlalgo.data_providers.ibkr_data_executor import _fmt_price, _fmt_int
