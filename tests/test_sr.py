...
def test_identify_pivots_and_vwap():
    bars = [
        ...
        Bar(
            timestamp=pd.Timestamp("2025-01-01 00:02:00"),
            high=11,
            low=9,
            close=10,
            volume=100,
...
def test_calculate_support_resistance():
    bars = [
        ...
        Bar(
            timestamp=pd.Timestamp("2025-01-01 00:03:00"),
            high=13,
            low=10,
            close=12,
            volume=130,
        ...
        Bar(
            timestamp=pd.Timestamp("2025-01-01 00:04:00"),
            high=12,
            low=10,
            close=11,
            volume=110,
...
def test_premarket_and_swing_levels():
    ...
    bars = [
        ...
        Bar(
            timestamp=pd.Timestamp("2025-01-01 08:15:00"),
            high=101,
            low=99,
            close=100,
            volume=1100,
        ...
        Bar(
            timestamp=pd.Timestamp("2025-01-01 09:45:00"),
            high=103,
            low=101,
            close=102,
            volume=1300,
