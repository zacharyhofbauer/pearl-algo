...
inspired by Lux Algo Chart Prime's AI Strategy Alerts system.

Each bot is a complete trading system with:
- Indicator suite (PAC/S&O/OSC equivalent)
- Entry/exit rules and logic
- Risk management parameters
- Performance tracking
- Alert/webhook capabilities

Like Lux Algo, these bots can be deployed as zero-code automated strategies.
"""
...
class LuxAlgoBot(ABC):
    """
    Abstract base class for Lux Algo Chart Prime style automated trading bots.

    Each bot is a complete, self-contained trading system inspired by Lux Algo's
    AI Strategy Alerts - combining indicators, rules, risk management, and automation.
    """
...
BOT_REGISTRY: Dict[str, type[LuxAlgoBot]] = {}


def register_bot(bot_class: type[LuxAlgoBot]) -> None:
    """Register a bot class for creation by name."""
    BOT_REGISTRY[bot_class.__name__] = bot_class


def create_bot(bot_name: str, config: BotConfig) -> LuxAlgoBot:
