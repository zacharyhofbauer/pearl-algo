...
@click.option("--symbols", multiple=True, default=["ES", "NQ", "GC"], help="Symbols to process")
@click.option("--source", type=click.Choice(["ibkr", "csv"]), default="ibkr", help="Data source")
@click.pass_context
