...
def help_cmd(section: str | None = None, full: bool = False, pager: bool = True, no_pager: bool = False) -> None:
    """
    ...
    try:
        ...
        if not section:
            if short:
                console.print("[dim]💡 For full documentation: 'pearlalgo help --full'[/dim]")
                console.print("[dim]   Or 'pearlalgo help --section <name>' for specific sections[/dim]")
            else:
                sections = get_sections(content)
                if sections:
                    console.print("[dim]💡 Tip: Use 'pearlalgo help' (without --full) for quick daily reference[/dim]")
                    console.print("[dim]   Or 'pearlalgo help --section <name>' for specific sections[/dim]")
        console.print()
...
def cheat_sheet_cmd(section: str | None = None, full: bool = False, pager: bool = True, no_pager: bool = False) -> None:
