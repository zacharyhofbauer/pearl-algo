...
@dataclass
class MassiveHealthMetrics:
    """Health metrics for Massive API."""
...
class MassiveHealthMonitor:
    """Monitor Massive API health and rate limits."""
    
    def __init__(self):
        """Initialize health monitor."""
        self.metrics = MassiveHealthMetrics()
    ...
    def record_rate_limit(self) -> None:
        ...
        logger.warning("Massive API rate limit hit recorded")
    
    def record_unauthorized(self) -> None:
        """Record an unauthorized error."""
        self.metrics.unauthorized_errors += 1
        logger.error("Massive API unauthorized error recorded")
    
    def record_timeout(self) -> None:
        """Record a timeout error."""
        self.metrics.timeout_errors += 1
        logger.warning("Massive API timeout error recorded")
    
    def record_circuit_breaker_open(self) -> None:
        """Record circuit breaker opening."""
        self.metrics.circuit_breaker_opens += 1
        logger.error("Massive API circuit breaker opened")
    ...
    def reset(self) -> None:
        """Reset all metrics."""
        self.metrics = MassiveHealthMetrics()
        logger.info("Massive health metrics reset")
