...
| `src/pearlalgo/market_agent/` | Live service orchestration, state, and performance tracking |
| `config/base.yaml` | Shared runtime defaults |
| `config/accounts/tradovate_paper.yaml` | Active account overlay |
| `data/agent_state/<MARKET>/trades.db` | Current SQLite runtime database |
