...
echo ""
echo "Commands:"
echo "  Start all:     sudo systemctl start ibkr-gateway pearlalgo-agent pearlalgo-api pearlalgo-webapp"
echo "  Stop all:      sudo systemctl stop pearlalgo-webapp pearlalgo-api pearlalgo-agent ibkr-gateway"
echo "  Enable boot:   sudo systemctl enable ibkr-gateway pearlalgo-agent pearlalgo-api pearlalgo-webapp"
echo "  Disable boot:  sudo systemctl disable ibkr-gateway pearlalgo-agent pearlalgo-api pearlalgo-webapp"
