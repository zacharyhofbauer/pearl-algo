...
#
# Removes every pearlalgo/ibkr systemd service so that ./pearlalgo.sh is the ONLY
...
echo "============================================"
echo ""
echo "  ./pearlalgo.sh is now the ONLY way to control the stack."
echo ""
echo "  Next steps (run as pearl, no sudo):"
echo "    cd /home/pearlalgo/PearlAlgoWorkspace"
echo "    ./pearlalgo.sh start"
echo ""
