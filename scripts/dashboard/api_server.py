#!/usr/bin/env python3
"""
Dashboard API Server - Serves OHLCV data for the TradingView dashboard.
...
Usage:
  python scripts/dashboard/api_server.py --market NQ --port 8000
"""
    ...
    try:
        ...
        provider = create_provider(
            ...
            config={
                ...
                "client_id": int(os.getenv("IB_CLIENT_ID_DASHBOARD", "99")),
            }
        )
...
app = FastAPI(
    title="PEARL Dashboard API",
    description="API for the PEARL trading dashboard",
    version="1.0.0",
)
...
def main():
    ...
    print(f"Starting Dashboard API Server")
