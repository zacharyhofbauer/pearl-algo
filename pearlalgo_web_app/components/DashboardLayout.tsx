      ...
      <main className="tv-layout" id="main-content">
        ...
        <div className="tv-body" data-chart-ready={isChartReady ? 'true' : 'false'}>
          <aside className="tv-sidebar tv-sidebar-left" aria-label="Widgets">
            <button className="tv-sidebar-icon" title="Watchlist">
            ...
            <button className="tv-sidebar-icon" title="Alerts">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
          ...
          <aside className="tv-sidebar tv-sidebar-right" aria-label="Tools">
            ...
            <button className="tv-sidebar-icon" title="Trendline">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
            ...
            <button className="tv-sidebar-icon" title="Text label">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
                <path d="M4 4h10M9 4v11M6 15h6"/>
              </svg>
            </button>
