...
| Section | File Path |
|---------|-----------|
| 1 | `apps/pearl-algo-app/components/DashboardLayout.tsx` |
| 2 | `apps/pearl-algo-app/app/dashboard/DashboardPageInner.tsx` (lines 560-575, the rightPanelContent block) |
| 3 | `apps/pearl-algo-app/components/WatchlistPanel.tsx` |
| 4 | `apps/pearl-algo-app/components/SystemLogsPanel.tsx` |
| 5 | `apps/pearl-algo-app/stores/uiStore.ts` |
| 6 | `apps/pearl-algo-app/styles/components/_right-panel.css` |
| 7 | `apps/pearl-algo-app/styles/layouts/_tv-layout.css` |
