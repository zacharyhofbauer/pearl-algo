...
describe('LandingPage', () => {
  ...
  it('renders timeline milestones in order', () => {
    ...
    expect(screen.getByText('Project born')).toBeInTheDocument()
    ...
    expect(screen.getByText('+$7.2K breakout')).toBeInTheDocument()
    expect(screen.getByText('Feb 3')).toBeInTheDocument()
    expect(screen.getByText('Peak +$9.6K')).toBeInTheDocument()
    expect(screen.getByText('Feb 5')).toBeInTheDocument()
    expect(screen.getByText('-$12.9K lesson')).toBeInTheDocument()
